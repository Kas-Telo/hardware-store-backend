...
export const addProduct = async (req, res) => {
  ...
  const isProductCreated = await productService.createNewProduct(category, label, model, price, rate, specification)
...
export const deleteProduct = async (req, res) => {
  ...
  const isProductDeleted = await productService.deleteProductById(req.params.id)
